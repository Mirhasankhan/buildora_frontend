...
const ProjectPage = () => {
  ...
  const project = (data as ProjectApiResponse | undefined)?.result;
      ...
      <div className="space-y-6">
            ...
            <div className="bg-white rounded-[6px] border border-gray-100 p-5">
              ...
              {project.workerProfiles.length === 0 ? (
                ...
                <div className="space-y-3">
                  {project.workerProfiles.map((workerProfile) => (
                    <div
        ...
        <section className="bg-white rounded-[12px] border border-gray-100 p-4 sm:p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Labor Daily Fees</h2>
          </div>
